...
module.exports = {
   ...
   */
  'section': function (reference, options) {
   ...
   */
  'eachSection': function (query, options) {
    var buffer = '',
        sections,
        i, l;
    ...
    sections = this.styleguide.section(query);
    if (!sections) return '';
   ...
   */
  'eachRoot': function (options) {
    var buffer = '',
        sections,
        i, l;

    sections = this.styleguide.section('x');
    if (!sections) return '';
   ...
   * {{/unlessDepth}}
   */
  'unlessDepth': function (depth, options) {
    if (!this.refDepth) {
      return '';
    }
   ...
   */
  'modifierMarkup': function (modifier) {
   ...
   */
  'whenDepth': function (depth, options) {
